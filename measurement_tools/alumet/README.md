...
> [!NOTE]
> Config format can change between versions. To ensure no missing required configurations, the default config file can be generated by running:
> ```bash
> alumet-agent --plugins procfs,csv,rapl,energy-attribution config regen
> ```
